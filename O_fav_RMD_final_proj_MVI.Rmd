...
*NOTE: The rare_D_GO.csv has its column with 'ofav' instead of 'isogroup', so that was replaced prior to GO analysis, so they can be linked to the GO annotations file. *
