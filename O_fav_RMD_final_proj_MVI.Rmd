...
Species of corals living in the Caribbeans are continuously threatened by increasing sea surface temperatures. These corals are at risk for thermal bleaching as the warmer waters cause them to lose their photosymbionts. As corals depend on the photosynthetic algal symbionts for much of their nutritional needs, bleaching leads to death with concerning frequency and severity.

In certain species of corals, research has shown the presence of different strains of photosymbionts. There is evidence to show that some strains are more thermotolerant than others. While there are studies on this phenomenon in other species of coral, it is unexplored in endangered species *Orbicella faveolata*. The goal of this analysis is to explore the molecular pathways associated with the tolerances of Symbiodiniaceae strain B01 and Symbiodiniaceae strain D and to better understand the differences of these two on a genetic level.

Using rarefied transcriptome data from [“Whole transcriptome analysis reveals changes in expression of immune-related genes during and after bleaching in a reef-building coral”](https://doi.org/10.1098/rsos.140214) by J.H. Pinzon in 2015, gene ontology analysis allowed for the identification of genes of interest and the exploration of the differences in gene regulation between strains.
