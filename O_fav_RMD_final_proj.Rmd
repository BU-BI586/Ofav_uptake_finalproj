...
totalCounts
barplot(totalCounts, col=c("green",  "green", "green", "green", "red", "red", "red", "blue", "blue" , "blue" , "blue"), ylab="raw counts")
min(totalCounts)
max(totalCounts)

oldColNames = colnames(countData)

newCounts = countData %>% 
  dplyr::select(-BR.D.fav_uptake_S4_L007_R1_001.fastq.trim.sam.counts, -CR.A.fav_uptake_S5_L007_R1_001.fastq.trim.sam.counts, -CR.B.fav_uptake_S6_L007_R1_001.fastq.trim.sam.counts, -CR.C.fav_uptake_S7_L007_R1_001.fastq.trim.sam.counts, -DR.B.fav_uptake_S9_L007_R1_001.fastq.trim.sam.counts)

head(newCounts)
colnames(newCounts)
newColNames = c("BR.A", "BR.B", "BR.C", "DR.A", "DR.C", "DR.D")


#1 2 3 8 10 11

```
```{r, echo=FALSE, fig.cap="Figure 1. Raw Counts of O.Fav where BR are coral have taken up symbiodinicae B and DR are coral that have taken up symbiodinicae D."}
colnames(newCounts)=paste(newColNames)
...
v = setwd("~/BI 586/FinalProject/outliers")
...
```{r, echo=FALSE, fig.cap="Figure 2. Dispersion plot uptake"}
...
```
```{r, echo=FALSE, fig.cap="Figure 3. Histogram of r-log transformations"}
hist(assay(rld))
```
...
```{r, echo=FALSE, fig.cap="Figure 5. Sample distance heatmap where BR.C is clustering more with D."}
...
summary(resBD)
```
```{r, echo=FALSE, fig.cap="Figure 6. MA plot between B and D."}
...
```{r, echo=FALSE, fig.cap="Figure 7. Sample Distance Matrix between B and D."}
...
```{r, echo=FALSE, fig.cap="Figure 8. Principal Component Analysis of B vs D."}
